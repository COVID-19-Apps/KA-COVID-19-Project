package com.kacovid19project.Models;

public class Jsons {

    String videos, home_treatment_images, home_treatment_links, toll_numbers, lab_test, donate,
            tweets, faq, epass, tracker, migrant, corona, ka, cbse, vocational_education, go, doctor;

    public Jsons() {
    }

    public Jsons(String videos, String home_treatment_images, String home_treatment_links, String toll_numbers, String lab_test, String donate, String tweets, String faq, String epass, String tracker, String migrant, String corona, String ka, String cbse, String vocational_education, String go, String doctor) {
        this.videos = videos;
