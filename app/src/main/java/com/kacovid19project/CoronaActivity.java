...
import com.kacovid19project.Adapter.CoronaAdapter;
import com.kacovid19project.Adapter.FAQAdapter;
import com.kacovid19project.Models.Corona;
import com.kacovid19project.Models.FAQ;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Karnataka").getJSONObject("districtData");
